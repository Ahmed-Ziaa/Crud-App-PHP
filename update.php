...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE `crud`.`user` SET `username` = '$username', `email` = '$email', `password` = '$password' WHERE `user`.`id` = $id ;
";
...
<body>
    ...
    <div class="header text-center text-white p-2" style="background-color: black; border-top: 8px solid green  ;">
